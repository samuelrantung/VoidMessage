...
const CreateRoomModal: FC<Props> = ({isOpen, setIsOpen}) => {
  ...
  const handleContinue = async () => {
    ...
    await socket.emit('create_room', name);
    await socket.on('active_room', async roomId => {
      console.log('roomId hehe', roomId);
      await dispatch(changeActiveRoom(roomId));
    });
    setIsOpen(false);
